...
results, observations, priors, metadata = SideKicks.ExtractResults(String(@__DIR__) * "/results.hdf5")
...
plotting_props = SideKicks.createPlottingProps([
    ...
    [:vkick, km_per_s,  [44,56],         L"v_{kick}  \;[\mathrm{km s}^{-1}]"],
    #[:θ,  1,      missing,    L"theta"],
    #[:ϕ,  1,      missing,    L"phi"],
...
plotting_props = SideKicks.createPlottingProps([
    [:m1_f,    m_sun,    [15,40],        L"M_1\;[M_{\odot}]"],
    #[:m2_f,    m_sun,    [0,100],        L"M_2\;[M_{\odot}]"],
    #[:m1_i,    m_sun,    [15,40],        L"M_1\;[M_{\odot}]"],
    #[:P_f,   day,      [10.3,10.45],    L"P_f\;[\mathrm{days}]"],
    #[:P_i,   day,      [10.3,10.45],    L"P_f\;[\mathrm{days}]"],
    [:m2_f,     m_sun,    [10,15],         L"M_2  \;[M_{\odot}]"],
    #[:m2_f,     m_sun,    [0,25],         L"M_2  \;[M_{\odot}]"],
    #[:m2_f,     m_sun,    [0,25],         L"M_2  \;[M_{\odot}]"],
    #[:dm2,    m_sun,    [0, 4],        L"ΔM_2  \;[M_{\odot}]"],
    #[:dm2,    m_sun,    [0, 4],        L"ΔM_2  \;[M_{\odot}]"],
